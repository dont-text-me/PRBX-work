...
\begin{table}
    ...
    \begin{tabular}{*7l}
        \toprule
        \textbf{Class} & \multicolumn{2}{c}{Precision} & \multicolumn{2}{c}{Recall} & \multicolumn{2}{c}{F1 score} \\
        \midrule
        {} & KNN-1 & KNN-2 & KNN-1 & KNN-2 & KNN-1 & KNN-2 \\
            \textbf{Normal} & 0.77 & 0.78 & 0.95 & 0.92 & 0.85 & 0.84  \\
            \textbf{Quaker} & 0.73 & 0.74 & 0.83 & 0.81 & 0.76 & 0.77 \\
            \textbf{Bean fragment} & 0.82 & 0.58 & 0.15 & 0.12 & 0.25 & 0.20 \\
            \textbf{Underroasted} & 1.00 & 0.71 & 0.05 & 0.57 & 0.09 & 0.63 \\
            \textbf{Burnt} & 0.00 & 1.00 & 0.00 & 0.30 & 0.00 & 0.46 \\
            \textbf{Insect/Mould} & 0.00 & 0.50 & 0.00 & 0.11 & 0.00 & 0.18  \\
...
metrics over the KNN classifier, with the results presented below %TODO finish this table
