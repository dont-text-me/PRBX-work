...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{results/best-performers-timings}
    \caption{Time taken to classify the test dataset for best performers}
    \label{fig:real-world-timings}
\end{figure}
