...
To achieve these aims, a convolutional neural network (CNN) was selected as a design candidate, based on their
...
The MobileNet V2 architecture stood out for its relatively small number of parameters and a promised ability to run even on
a mobile device.
...
Other smaller architectures such as EfficientNet were considered and trialled in preliminary experiments,
