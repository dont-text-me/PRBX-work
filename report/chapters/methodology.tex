...
\begin{wrapfigure}{r}{0.4\textwidth}
    ...
    \caption{Residual block~\cite{resNet}}
    \label{fig:residualBlock}
\end{wrapfigure}
The main innovation behind this family of classifiers is their use of ''residual blocks``, an architecture where the output of
