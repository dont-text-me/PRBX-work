...
On the simpler side of image classification algorithms lies an application of a %--------------KNN section----------------
...
A more modern and complex solution can be found in neural networks. %--------------------------Neural nets section----
These classifiers
...
\cite{hyperspectralChen}, who have achieved an accuracy of 98.6\% when %--------Neural net-------
...
The paper's main strengths were in its
design of the image processing pipeline and classifier architecture.
The capturing
...
Oliveri et al.\  take a slightly different approach in their 2019 paper~\cite{hyperspectralGreenOliveri}. %-----KNN----
...
A 2017 paper by Nasution and Andayani~\cite{manyRoastLevelsNasution} shows a %-------Neural net------
...
\end{wrapfigure}
A paper with one of the closest aims to this project was written by Shao et al.\ in %----------Neural net-----
...
Apart from the described usage of expensive and complex machinery to %------- Neural net
...
\cite{eronCoffeeCherryOnTrees}, proposing the use of image classifiers at two stages %------- Neural net + KNN (neural net section)
of the process.
